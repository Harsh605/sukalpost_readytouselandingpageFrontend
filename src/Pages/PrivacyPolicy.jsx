  ...
  return (
    <div style={{padding:'2rem'}}>
      ...
      <section style={{ padding: "8rem" }}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to software It
              company, 30-A, Gopalpura Bypass Rd, opp. Holiday Inn Hotel, opp.
              Holiday Inn, Sultan Nagar, Santi Nagar, Gurjar Ki Thadi, Jaipur,
              Rajasthan 302020 .
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to readytousesoftwares, accessible
              from{" "}
              <a
                href="https://readytousesoftwares.metablocktechnologies.in/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://readytousesoftwares.metablocktechnologies.in/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By phone number: +91 935 859 3003</li>
        </ul>
      </section>
    </div>
  );
